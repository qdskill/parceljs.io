...
git remote set-url origin git@github.com:docschina/parceljs.io.git


openssl aes-256-cbc -K $encrypted_4822b90417d6_key -iv $encrypted_4822b90417d6_iv -in shell/deploy_key.enc -out shell/deploy_key -d
